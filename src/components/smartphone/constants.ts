export const APPS = [
    ...
    { id: 'sns', name: 'Buzzer', icon: '🐦', color: 'bg-blue-400', description: 'つぶやきSNS' },
    { id: 'video', name: 'Tube', icon: '▶', color: 'bg-red-500', description: '動画共有' },
    { id: 'news', name: 'ニュース', icon: '📰', color: 'bg-orange-500', description: 'ワールドニュース' },
    ...
    { id: 'dark_web', name: 'Dark Web', icon: '💀', color: 'bg-slate-900', description: 'Encrypted' },
