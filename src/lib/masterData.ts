...
export const JOBS: { [name: string]: MasterJob } = {
  '無職': { name: '無職', description: 'アルバイトや宝探しなど、自由な生き方ができる。', requiresQualification: null, type: '通常' },
  'ケーキ屋': { name: 'ケーキ屋', description: 'タイミングゲームで美味しいケーキを作る。', requiresQualification: null, type: '通常' },
  '警察官': { name: '警察官', description: '探し物ミニゲームで町の人々の困りごとを解決する。夜にパトロールができる。', requiresQualification: null, type: '通常' },
  'Youtuber': { name: 'Youtuber', description: '記憶力ゲームで面白い動画を撮影する。', requiresQualification: null, type: '通常' },
  '農家': { name: '農家', description: '毎ターン1万円の安定収入がある。', requiresQualification: null, type: '通常' },
  '投資家': { name: '投資家', description: '株の売買手数料が無料になる。(通常5%)', requiresQualification: null, type: '通常' },
  'アイドル': { name: 'アイドル', description: '『応援を求める』コマンドで臨時収入を得られることがある。', requiresQualification: null, type: '通常' },
  '公務員': { name: '公務員', description: '毎ターン3万円の安定収入があり、住民税が免除される。', requiresQualification: null, type: '通常' },
  'アニメーター': { name: 'アニメーター', description: 'パラパラ漫画を作るミニゲームで作品を制作する。', requiresQualification: null, type: '通常' },
  '小説家': { name: '小説家', description: '物語のアイデアを考えて、ベストセラーを目指す。', requiresQualification: null, type: '通常' },
  'ミュージシャン': { name: 'ミュージシャン', description: 'リズムゲームで作曲し、ファンを増やす。', requiresQualification: null, type: '通常' },
  '探偵': { name: '探偵', description: '証拠を集めて、簡単な事件を解決する。', requiresQualification: null, type: '通常' },
  'プログラマー': { name: 'プログラマー', description: 'コードの間違い探しゲームでアプリを開発する。', requiresQualification: null, type: '通常' },
  '花屋': { name: '花屋', description: '注文通りに花束を作るミニゲーム。', requiresQualification: null, type: '通常' },
  'タクシー運転手': { name: 'タクシー運転手', description: 'お客さんを目的地まで最短ルートで送り届ける。', requiresQualification: null, type: '通常' },
  'パン屋': { name: 'パン屋', description: '美味しいパンを焼いてお店に並べる。', requiresQualification: null, type: '通常' },
  '漫画家': { name: '漫画家', description: '面白いオチを考えて4コマ漫画を完成させる。', requiresQualification: null, type: '通常' },
  '科学者': { name: '科学者', description: 'フラスコを混ぜて新発見を目指す実験ゲーム。', requiresQualification: null, type: '通常' },
  '郵便配達員': { name: '郵便配達員', description: '指定されたルートを覚えて正確に配達するミニゲーム。', requiresQualification: null, type: '通常' },
  '美容師': { name: '美容師', description: '髪型の注文に合わせてカットするスピード＆記憶ゲーム。', requiresQualification: null, type: '通常' },
  'ペットショップ店員': { name: 'ペットショップ店員', description: '動物たちの世話をしながら来客に対応する。', requiresQualification: null, type: '通常' },
  'カフェ店員': { name: 'カフェ店員', description: 'ドリンクやスイーツを正確に提供する。接客力が問われる。', requiresQualification: null, type: '通常' },
  '家具職人': { name: '家具職人', description: '部品を組み立てて家具を完成させるパズルゲーム。', requiresQualification: null, type: '通常' },
  'ガイド': { name: 'ガイド', description: '観光客に観光地を案内し、知識と対応力が求められる。', requiresQualification: null, type: '通常' },
  '引越し業者': { name: '引越し業者', description: '荷物を効率よく詰めるテトリス風ミニゲーム。', requiresQualification: null, type: '通常' },
  'レジ打ち': { name: 'レジ打ち', description: 'スキャン速度＆金額の正確さが求められる。', requiresQualification: null, type: '通常' },
  '書店員': { name: '書店員', description: '客の要望に合わせた本を素早く探し出す。', requiresQualification: null, type: '通常' },
  '郵便局員': { name: '郵便局員', description: '書類の分類と処理をこなす地味だが重要な仕事。', requiresQualification: null, type: '通常' },
  '雑貨屋': { name: '雑貨屋', description: '小物を売って利益を上げる。仕入れ選定のセンスが必要。', requiresQualification: null, type: '通常' },
  '水族館スタッフ': { name: '水族館スタッフ', description: '魚たちの世話や水槽のメンテナンスを行う。', requiresQualification: null, type: '通常' },
  'バーテンダー': { name: 'バーテンダー', description: '注文通りのカクテルを作成。センスと記憶力勝負。', requiresQualification: null, type: '通常' },
  'DJ': { name: 'DJ', description: 'リズムに合わせて盛り上げる音楽系職。夜イベントにも強い。', requiresQualification: null, type: '通常' },
  '大道芸人': { name: '大道芸人', description: '技を決めて観客の注目を集める。失敗するとブーイング。', requiresQualification: null, type: '通常' },
  '医者': { name: '医者', description: '診断ミニゲームで人々を助ける。', requiresQualification: 'medical_license', type: '特殊' },
  'エンジニア': { name: 'エンジニア', description: '土地の購入費用が20%割引になる。夜に残業ができる。', requiresQualification: 'engineer_cert', type: '特殊' },
  '料理人': { name: '料理人', description: '商品の売上が10%上乗せされ、新しいレシピをひらめきやすい。', requiresQualification: 'chef_license', type: '特殊' },
  '検事': { name: '検事', description: 'プレイヤーを起訴する権限を持つ。', requiresQualification: 'law_license', type: '特殊' },
  '弁護士': { name: '弁護士', description: '被告人を弁護する。', requiresQualification: 'law_license', type: '特殊' },
  '看守': { name: '看守', description: '刑務所の受刑者を管理する。', requiresQualification: null, type: '特殊' },
  '建築家': { name: '建築家', description: '新しい物件を設計・建設できる。', requiresQualification: 'architect_cert', type: '特殊' },
  'パイロット': { name: 'パイロット', description: '長距離移動ができる。飛行中に特殊イベントが起きることも。', requiresQualification: 'pilot_license', type: '特殊' },
  '薬剤師': { name: '薬剤師', description: '処方された薬を正しく調合・提供する。', requiresQualification: 'pharmacist_cert', type: '特殊' },
  '救急救命士': { name: '救急救命士', description: '一刻を争う対応を迫られる。緊急イベントで活躍。', requiresQualification: 'emergency_cert', type: '特殊' },
  'プロゲーマー': { name: 'プロゲーマー', description: 'eスポーツ大会に参加でき、ランキング報酬がある。', requiresQualification: 'pro_license', type: '特殊' },
  'ロボット技術者': { name: 'ロボット技術者', description: 'AIロボの開発ができる。新技術の研究が可能。', requiresQualification: 'engineer_cert', type: '特殊' },
  '占い師': { name: '占い師', description: '他プレイヤーの運勢を操作できるミステリアス職。', requiresQualification: null, type: '特殊' },
  '宇宙飛行士': { name: '宇宙飛行士', description: '宇宙ミッションイベントに参加できるレア職。', requiresQualification: 'astronaut_cert', type: '特殊' },
  '記者': { name: '記者', description: '社会の出来事を取材し、記事として発信。真実を暴ける。', requiresQualification: null, type: '特殊' },
  '通訳者': { name: '通訳者', description: '外国イベントで活躍。多言語に対応可能。', requiresQualification: 'language_cert', type: '特殊' },
  '考古学者': { name: '考古学者', description: '遺跡を発掘してレアアイテムを見つけることがある。', requiresQualification: null, type: '特殊' },
  'ゲーム開発者': { name: 'ゲーム開発者', description: '他プレイヤーがプレイするミニゲームを設計可能。', requiresQualification: 'engineer_cert', type: '特殊' },
  'クラッカー': { name: 'クラッカー', description: 'ハッキングや窃盗などの犯罪活動に特化している。', requiresQualification: null, type: '犯罪' },
  '軽犯罪者': { name: '軽犯罪者', description: '法を一度だけ破った者。まだ引き返せるかもしれない。', requiresQualification: null, type: '犯罪' },
  '犯罪者': { name: '犯罪者', description: '犯罪に手を染め、裏社会に足を踏み入れた者。', requiresQualification: null, type: '犯罪' },
  '凶悪犯': { name: '凶悪犯', description: 'もはやカタギの世界には戻れない重罪人。', requiresQualification: null, type: '犯罪' },
  '指名手配犯': { name: '指名手配犯', description: '警察に追われる身となった危険人物。', requiresQualification: null, type: '犯罪' },
  '極悪犯罪者': { name: '極悪犯罪者', description: 'その名を聞けば誰もが震え上がる大悪党。', requiresQualification: null, type: '犯罪' },
  '永久指名手配犯': { name: '永久指名手配犯', description: '国家を敵に回した、伝説の犯罪者。', requiresQualification: null, type: '犯罪' },
  '詐欺師': { name: '詐欺師', description: '他プレイヤーを騙して金品を得る。バレるとリスク大。', requiresQualification: null, type: '犯罪' },
  '密輸業者': { name: '密輸業者', description: '違法アイテムの流通に関与。成功すれば高報酬。', requiresQualification: null, type: '犯罪' },
  '裏社会の仲介人': { name: '裏社会の仲介人', description: '犯罪系プレイヤー間の交渉や取引を取り持つ。', requiresQualification: null, type: '犯罪' },
  '情報屋': { name: '情報屋', description: 'あらゆる情報を売買し、他人の秘密を握る。', requiresQualification: null, type: '犯罪' },
  '殺し屋': { name: '殺し屋', description: '任意のプレイヤーを一時的にゲームから排除できる。', requiresQualification: null, type: '犯罪' },
  'スパイ': { name: 'スパイ', description: '他プレイヤーの行動ログを覗き見できる能力を持つ。', requiresQualification: null, type: '犯罪' },
  'ダークウェブ管理者': { name: 'ダークウェブ管理者', description: '犯罪取引の仲介や拡散を行う謎多き存在。', requiresQualification: null, type: '犯罪' },
  '爆弾魔': { name: '爆弾魔', description: '施設やイベントに干渉できるが、リスクも高い。', requiresQualification: null, type: '犯罪' },
  '黒幕': { name: '黒幕', description: '犯罪者たちのボス。一度だけ巨大な計画を実行可能。', requiresQualification: null, type: '犯罪' },
  '裏切り者': { name: '裏切り者', description: '他プレイヤーの信頼を裏切り、資源を奪うことができる。', requiresQualification: null, type: '犯罪' },
  '密猟者': { name: '密猟者', description: '動物を違法に捕獲し、希少アイテムを得る。', requiresQualification: null, type: '犯罪' },
  '麻薬製造者': { name: '麻薬製造者', description: '違法薬物を製造・販売し、高額な利益を得る。', requiresQualification: null, type: '犯罪' }
};
